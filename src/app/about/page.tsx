...
const differentiators = [
  "Une approche personnalisable à chaque studio et à chaque envie.",
  "Des prix clairs, sans surprises ni frais cachés.",
  "Des sites modernes, évolutifs et pensés pour être visibles par vos élèves.",
  ...
  return (
    <>
      ...
      >
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
          <div className="space-y-6 text-base leading-8 text-[var(--color-muted-foreground)]">
            <p>
              Nous sommes Adrien et Ophélie, un couple uni depuis plus de deux ans et désormais associés dans une même vision : mettre le web à la portée de vos studios.
            </p>
            <p>
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            ...
            <div className="rounded-[2rem] border border-white/10 bg-white/5 p-4">
              <div className="relative aspect-[4/5] overflow-hidden rounded-[1.5rem]">
                <Image
                  src="/images/team/adrien.jpg"
                  alt="Adrien — co-fondateur de L'Agence Grey"
                  fill
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4">
                  <p className="text-xl font-semibold text-white">Adrien</p>
                </div>
              </div>
            </div>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <article className="rounded-[2rem] border border-white/10 bg-white/5 p-7">
            ...
            <div className="mt-5 space-y-4 text-base leading-8 text-[var(--color-muted-foreground)]">
              ...
              <p>
                Mais par-dessus-tout, j&apos;ai comme passion la pole dance depuis un an et demi et j&apos;ai pu cerner vos besoins, mais surtout ceux de vos élèves. Car c&apos;est déjà assez intimidant de prendre son premier cours de pole dance ou de pilates ; c&apos;est à nous de rendre la prise de rendez-vous simple et rapide, sur un site rassurant et inclusif.
              </p>
              <p>
      ...
      <SectionWrapper
        ...
        description="Chez Grey, nous aidons les studios de yoga, pole dance et sport en tous genres à développer leur visibilité en ligne sans perdre de temps."
      >
        <div className="grid gap-6 lg:grid-cols-[1fr_0.9fr]">
          <div className="space-y-5 text-base leading-8 text-[var(--color-muted-foreground)]">
            <p>
              Notre objectif : vous permettre d&apos;avoir un site internet visible, clair et efficace — sans que vous n&apos;ayez à vous soucier de la technique.
            </p>
            <p>
              Parce que vous avez déjà des cours à assurer, nous avons imaginé une solution simple, rapide et adaptée à vous, pour que votre présence en ligne soit un véritable atout, et non une contrainte.
            </p>
          </div>
        ...
        <div className="rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,_rgba(168,85,247,0.12),_rgba(255,255,255,0.04))] p-8">
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="space-y-4 text-base leading-8 text-[var(--color-muted-foreground)]">
              ...
              <p>
                Nos offres s&apos;articulent autour de trois niveaux d&apos;accompagnement : la création de site sur mesure, la gestion et l&apos;optimisation continue (maintenance, visibilité, modifications) et, pour les entreprises qui souhaitent accélérer leur croissance, des solutions avancées intégrant automatisations intelligentes et campagnes publicitaires en option.
              </p>
            </div>
            <div className="space-y-4 text-base leading-8 text-[var(--color-muted-foreground)]">
              <p>
                L&apos;objectif reste toujours le même : vous offrir une présence en ligne claire, rassurante et efficace, sans vous faire perdre de temps ni alourdir votre quotidien.
              </p>
              <p>
                L&apos;objectif est toujours le même : vous permettre de rester concentrés sur votre activité pendant que nous veillons sur votre visibilité en ligne.
              </p>
            </div>
          </div>
        </div>
